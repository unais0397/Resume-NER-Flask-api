...
def extract_resume_entities(resume_text, model_path="best_resume_ner_model.pt"):
    """
    Extract and group named entities from resume text using a fine-tuned BERT model.
